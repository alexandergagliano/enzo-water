  ...
  */
  ...
  if (withWater){
     ...
     if (water_rates == 3){
       ...
       FieldType[SplusNum   = NumberOfBaryonFields++] = SplusDensity;
       FieldType[SiNum      = NumberOfBaryonFields++] = SiDensity;
       FieldType[SiplusNum  = NumberOfBaryonFields++] = SiplusDensity;
       FieldType[CHplusNum  = NumberOfBaryonFields++] = CHplusDensity;
       FieldType[CH2plusNum = NumberOfBaryonFields++] = CH2plusDensity;
       FieldType[SiONum     = NumberOfBaryonFields++] = SiODensity;
	...
	if (MultiMetals) {
	  for (i = 0; i < size; i++) {
        ...
        if (withWater){
         ...
         printf("We've at least initialized water...\n");
         if (water_rates == 3){
           BaryonField[SNum][i]       = tiny_number;
           BaryonField[SplusNum][i]   = tiny_number;
           BaryonField[SiNum][i]      = tiny_number;
           BaryonField[SiplusNum][i]  = tiny_number;
           BaryonField[CHplusNum][i]  = tiny_number;
           BaryonField[CH2plusNum][i] = tiny_number;
           BaryonField[SiONum][i]     = tiny_number;
           BaryonField[H3plusNum][i]  = tiny_number;
           printf("Got past initalization!\n");
         }
       }
