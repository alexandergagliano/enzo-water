			       ...
			       HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  char *SplusName = "Splus_Density";
  char *SiName = "Si_Density";
  char *SiplusName = "Siplus_Density";
  char *CHplusName = "Hplus_Density";
  char *CH2plusName = "CH2plus_Density";
  char *SiOName = "SiO_Density";
  ...
  */
  ...
  if (withWater) {
    ...
    if (water_rates == 3){
      DataLabel[i++] = SName;
      DataLabel[i++] = SplusName;
      DataLabel[i++] = SiName;
      DataLabel[i++] = SiplusName;
