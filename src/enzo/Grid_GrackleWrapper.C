...
int grid::GrackleWrapper()
{
  ...
  if (MultiSpecies)
    ...
    CplusNum, CNum, CHNum, CH2Num, CH3Num, CH4Num, CONum, COplusNum, CO2Num, SNum, SplusNum,
    SiNum, SiplusNum, CHplusNum, CH2plusNum, SiONum, H3plusNum = 0;
  ...
  if (withWater){
      ...
      if (water_rates == 3){
        ...
        my_fields.Splus_density   = BaryonField[SplusNum];
        my_fields.Si_density      = BaryonField[SiNum];
        my_fields.Siplus_density  = BaryonField[SiplusNum];
        my_fields.CHplus_density  = BaryonField[CHplusNum];
        my_fields.CH2plus_density = BaryonField[CH2plusNum];
        my_fields.SiO_density     = BaryonField[SiONum];
